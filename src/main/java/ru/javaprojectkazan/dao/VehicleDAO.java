...
public class VehicleDAO implements DAO<Vehicle>{
    ...
    public VehicleDAO() throws PropertyReaderException {
    }
    ...
    @Override
    public Vehicle get(String vin) throws Exception {
        try (PreparedStatement preparedStatement = dataSourceService.getPreparedStatement(DBCommand.
            ...
            if (resultSet.next()) {
                String model = resultSet.getString("part_name");
                Date dispatchDate = resultSet.getDate("dispatch_date");
                Date soldDate = resultSet.getDate("dispatch_date");
                Date warrantyExpireDate = resultSet.getDate("warranty_expire_date");
                int mileageAtLastClaim = resultSet.getInt("");
